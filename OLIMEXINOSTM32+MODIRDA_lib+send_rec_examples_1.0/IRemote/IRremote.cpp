...
HardwareTimer pwmtimer(PWM_TIMER),recvtimer(RECV_TIMER);
void timer_ISR();
...
void IRsend::enableIROut(int khz) {
  ...
  // See my Secrets of Arduino PWM at http://arcfn.com/2009/07/secrets-of-arduino-pwm.html for details.
    ...
    pwmtimer.setCount(0);      // probaby doesn't matter
    pwmtimer.refresh(); // start it up
    // pwmtimer.pause();
    pwmtimer.resume();
}
...
void IRrecv::enableIRIn() {
    ...
    recvtimer.setChannel1Mode(TIMER_OUTPUT_COMPARE);
    recvtimer.setCompare(TIMER_CH1, 1);  // Interrupt 1 count after each update
    recvtimer.attachCompare1Interrupt(timer_ISR);
