...
This version of the demo gives you an option to control the pins of LCD as GPIO (software SPI).
...
If you are using another hardware and your GPIO pins are on different position you need to edit the file "Olimexino-STM32.h" in the BoardHardware directory.

It should initialize the software SPI (GPIOs) and the LCD display and visualize the following text:
*** OLIMEX ***
   OLIMEXINO
    STM32 +
  MOD-LCD3310
