...
#define LCD_MOSI_MAKE_OUT()     pinMode (LCD3310_MOSI_DNUM, OUTPUT)
#define LCD_MOSI_HIGH()         digitalWrite (LCD3310_MOSI_DNUM, 1)
#define LCD_MOSI_LOW()          digitalWrite (LCD3310_MOSI_DNUM, 0)

#define LCD_SCK_MAKE_OUT()      pinMode (LCD3310_SCK_DNUM, OUTPUT)
#define LCD_SCK_HIGH()          digitalWrite (LCD3310_SCK_DNUM, 1)
#define LCD_SCK_LOW()           digitalWrite (LCD3310_SCK_DNUM, 0)
